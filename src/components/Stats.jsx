// this is a functional component specific for this file and with the help of this we could use it anywhere in this file without need of repeating the code or using (map)
...
// as here, the content written in <StatCard><StatCard/> is replaced with {children} line in StatCard function definition
...
export default function Stats(){
    ...
    const warningLevel=caffieneLevel<statusLevels['low'].maxLevel?
        'low':
